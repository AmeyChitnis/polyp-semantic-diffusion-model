...
class TrainLoop:
    ...
    def preprocess_input(self, data):
        ...
        #print("Type of input_label:", type(input_label))
        #print("Type of label_map:", type(label_map))
        #print("Shape of input_label:", input_label.shape)
        #print("Shape of label_map:", label_map.shape)
        #print("Max value in label_map:", label_map.max().item())
        #print("Min value in label_map:", label_map.min().item())
